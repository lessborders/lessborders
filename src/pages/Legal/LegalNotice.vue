  ...
  <div class="page-container mb-auto legal">
      <div class="container py-4">
        <div>
            ...
            <p>
                <strong>Phone: </strong>+49 (0)176 834 412 49<br>
                <strong>Email: </strong>service@lessborders.com<br>
                <strong>Internet: </strong>https://lessborders.com<br>
            </p>
            <p>
            ...
            <p>
                ...
                For illegal, incorrect or incomplete contents and for damages resulting from the use of external information, solely the provider of the page to which reference was made is liable.
            </p>

            <h2 class="pt-3">Online dispute resolution platform</h2>
            <p>
                As the law stands we are obliged to point to our customers that there is a new platform for online-dispute-resolutions, which should help to find an out-of-court settlement.  
                Responsible for this platform is the European Commission. Please click here: http://ec.europa.eu/odr
            </p>
            

            <h2 class="pt-3">Copyrights and trademarks</h2>
            <p>
                This website and its contents are subject to copyright. 
                This applies to their structure and all contained functions, information, data, text, image and audio materials and all components used for the functionality of this website. 
                The users may use the content in the context of the functionality of websites for their own, personal use. 
                Any further use without express consent is prohibited. 
                All rights to the content of this website or parts thereof are reserved.
            </p>
            <p>
                All published photos on this website are protected by copyright. 
