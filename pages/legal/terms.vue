    ...
    <v-container class="py-5">
        <div>
            ...
            <p>
                ...
                connected thereto (collectively, the “Site”). We are registered in Germany and have
                our registered office at Seidlhofstraße 18, Munich, Bavaria 80639. You agree that by
            ...
            <h2 class="pt-3">2. INTELLECTUAL PROPERTY RIGHTS</h2>
            <p>
            ...
            <h2 class="pt-3">3. USER REPRESENTATIONS</h2>
            <p>
                By using the Site, you represent and warrant that: 
                <ol>
                    <li>all registration information you submit will be true, accurate, current, and complete; </li>
                    <li>you will maintain the accuracy of such information and promptly update such registration information as necessary; </li>
                    <li>you have the legal capacity and you agree to comply with these Termd of Use; </li>
            ...
            <h2 class="pt-3">4. USER REGISTRATION</h2>
            <p>
            ...
            <h2 class="pt-3">5. FEES AND PAYMENT</h2>
            <p>
            ...
            <h2 class="pt-3">6. CANCELLATION</h2>
            <p>
                ...
                If you are unsatisfied with our services, please email us at admin@lessborders.com
                or call us at 017683441249.
            </p>

            <h2 class="pt-3">7. SOFTWARE</h2>
            <p>
                ...
                with these Terms of Use. Any Software and any related documentation is provided
            ...
            <h2 class="pt-3">8. PROHIBITED ACTIVITIES</h2>
            <p>
            ...
            <h2 class="pt-3">9. USER GENERATED CONTRIBUTIONS</h2>
            <p>
            ...
            <h2 class="pt-3">10. CONTRIBUTION LICENSE</h2>
            <p>
            ...
            <h2 class="pt-3">11. GUIDELINES FOR REVIEWS AND COMMENTS</h2>
            <p>
                We may provide you areas on the Site to leave reviews, comments or ratings. When posting a
                review, you must comply with the following criteria: (1) you should have firsthand
                experience with the person/entity being reviewed; (2) your review or comment should not contain
                offensive profanity, or abusive, racist, offensive, or hate language; (3) your review or comment
                should not contain discriminatory references based on religion, race, gender, national
                origin, age, marital status, sexual orientation, or disability; (4) your review or comment should not
                contain references to illegal activity; (5) you should not be affiliated with competitors if
                posting negative reviews or COMMENTS; (6) you should not make any conclusions as to the legality
                of conduct; (7) you must not knowingly post any factually false or misleading statements.
            </p>
            <p>
            ...
            <h2 class="pt-3">12. MOBILE APPLICATION LICENSE</h2>
            <h3>Use License</h3>
            <p>
            ...
            <h2 class="pt-3">13. SOCIAL MEDIA</h2>
            <p>
            ...
            <h2 class="pt-3">14. SUBMISSIONS</h2>
            <p>
            ...
            <h2 class="pt-3">15. U.S. GOVERNMENT RIGHTS</h2>
            <p>
                ...
                12.211 (for technical data). If our services are acquired by or on behalf of any agency
                within the Department of Defense, our services are subject to the terms of these
                Terms of Use in accordance with Defense Federal Acquisition Regulation (“DFARS”)
                227.7202‑3. In addition, DFARS 252.227‑7015 applies to technical data acquired by
                the DOD. This U.S. Government Rights clause is in lieu of, and supersedes, any
                other FAR, DFARS, or other clause or provision that addresses government rights in
                computer software or technical data under these Terms of Use.
            </p>

            <h2 class="pt-3">16. SITE MANAGEMENT</h2>
            <p>
            ...
            <p>
                ...
                <NuxtLink to="/legal/privacy">https://lessborders.com/legal/privacy</NuxtLink>
                ...
                in Germany, then through your continued use of the Site, you are transferring your
                data to Germany, and you agree to have your data transferred to and processed in
                Germany. Further, we do not knowingly accept, request, or solicit information from
            ...
            <h2 class="pt-3">18. COPYRIGHT INFRINGEMENTS</h2>
            <p>
            ...
            <h2 class="pt-3">19. TERM AND TERMINATION</h2>
            <p>
            ...
            <h2 class="pt-3">20. MODIFICATIONS AND INTERRUPTIONS</h2>
            <p>
            ...
            <h2 class="pt-3">21. GOVERNING LAW</h2>
            <p>
                These conditions are governed by and interpreted following the laws of Germany,
            ...
            <h2 class="pt-3">22. DISPUTE RESOLUTION</h2>
            ...
            <p>
                ...
                acceptance. The seat of arbitration shall be Munich, Germany. The language of the
            ...
            <h2 class="pt-3">23. CORRECTIONS</h2>
            <p>
            ...
            <h2 class="pt-3">24. DISCLAIMER</h2>
            <p>
            ...
            <h2 class="pt-3">25. LIMITATIONS OF LIABILITY</h2>
            <p>
            ...
            <h2 class="pt-3">26. INDEMNIFICATION</h2>
            <p>
            ...
            <h2 class="pt-3">28. ELECTRONIC COMMUNICATIONS, TRANSACTIONS AND SIGNATURES</h2>
            <p>
            ...
            <h2 class="pt-3">29. CALIFORNIA USERS AND RESIDENTS</h2>
            <p>
            ...
            <h2 class="pt-3">30. MISCELLANEOUS</h2>
            <p>
            ...
            <h2 class="pt-3">31. CONTACT US</h2>
            <p>
